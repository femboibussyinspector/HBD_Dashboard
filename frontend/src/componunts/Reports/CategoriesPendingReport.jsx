...
export function CategoriesPendingReport() {
  const [selectedCity, setSelectedCity] = useState("All"); 
  const [categorySearch, setCategorySearch] = useState("");

  // 1. Get List of Unique Cities (for Dropdown)
  ...
  const tableRows = useMemo(() => {
    ...
    return categories.map(category => {
      // Calculate pending count for this Category AND selected City
    ...
    <div className="mt-8 mb-12 px-4 max-w-5xl mx-auto">
      ...
      <div className="mb-4">
        <Typography variant="h4" color="blue-gray" className="font-bold">
          Categories Pending Report
        </Typography>
        <Typography variant="small" className="text-gray-500">
          Professional view of pending categories distribution.
        </Typography>
      </div>
...
export default CategoriesPendingReport;